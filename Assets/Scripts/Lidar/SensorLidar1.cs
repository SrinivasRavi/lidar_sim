...
public class SensorLidar1 : MonoBehaviour
{
    int CurrentRayCount;
    ...
    {
        Bridge = bridge;
        //UnityEngine.Debug.Log("OnBridgeAvailable1");
        Bridge.OnConnected += () =>
        {
            //UnityEngine.Debug.Log("OnBridgeAvailable2");
            WriterPointCloud2 = Bridge.AddWriter<Ros.PointCloud2>(TopicName);
            //UnityEngine.Debug.Log("OnBridgeAvailable3");
        };
    }
}