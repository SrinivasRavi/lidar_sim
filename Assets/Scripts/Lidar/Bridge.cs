...
namespace Comm
{
    ...
    public abstract class Bridge
    {
        ...
        public abstract Writer<T> AddWriter<T>(string topic); // RosBridge implements this
                                                              // public abstract Writer<T> AddWriter<T>(Comm.Bridge bridge); // LidarSensor implements this
